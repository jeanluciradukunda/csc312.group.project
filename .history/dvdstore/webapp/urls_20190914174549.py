...
urlpatterns = [
    ...
    path('userstbl/register2',views.register2, name='register2'),
    path('userstbl/register3',views.register3, name='register3'),
    path('userstbl/model_form_upload',views.model_form_upload, name='model_form_upload'),
