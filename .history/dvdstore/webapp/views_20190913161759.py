...
def checkout(request):
    ...
    #Amount
    trans = Transaction.objects.create(users_ID=user_ID, TransactionNumber=TransactionNumber, RentDate=RentDate, DueDate=, MovieTitle=MovieTitle, Payment_Method=payment,Amount=bill)
    trans.save()
