...
def checkout(request):
    ...
    #Amount
    trans = Transaction.objects.create(users_ID=users_ID, TransactionNumber=TransactionNumber, RentDate=RentDate, DueDate=DueDate, MovieTitle=MovieTitle, Payment_Method=payment,Amount=bill)
    trans.save()
