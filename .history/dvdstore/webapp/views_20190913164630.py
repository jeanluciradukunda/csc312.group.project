...
def checkout(request):
    ...
    #Amount
    trans = Transaction(users_ID=users_ID, TransactionNumber=TransactionNumber, RentDate=RentDate, DueDate=DueDate, MovieTitle=MovieTitle, Payment_Method=payment,Amount=Rstr(bill),dvdID=dvdID)
    trans.save()
