...
def checkout(request):
    ...
    #Amount
    trans = Transaction(users_ID=users_ID,  RentDate=RentDate, DueDate=DueDate, MovieTitle=MovieTitle, Payment_Method=payment,Amount="R"+str(bill),dvdID=dvdID)
    trans.save()
